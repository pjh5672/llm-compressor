...
class QuantGemma2Attention(Gemma2Attention):
    """Multi-headed attention from 'Attention Is All You Need' paper"""

    def __init__(
        self,
        attention: Gemma2Attention,
        quant_config,
        **kwargs,
    ):
        super().__init__(
...
class CompressGemma2ForCausalLM(Gemma2ForCausalLM, CompressForCausalLM):
    def __init__(
        self,
        config,
    ):
    ...
    def save_compressed(self, local_save_path):
        ...
        Gemma2ForCausalLM.save_pretrained(
            base_model,
            local_save_path,
...
if __name__ == "__main__":
    ...
    model_path = "d:\\models\\gemma-2-2b-it"
    tokenizer = AutoTokenizer.from_pretrained(model_path)
    model = CompressGemma2ForCausalLM.from_pretrained(
        model_path,
